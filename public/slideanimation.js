...
const actualizador = () => {
  ...
  return [chatBg, asideBg, textNButtonBg, leftBg, rightBg, onlinecolor, ownerColor, bold, svgColor, text, lorem, ponlinetext, turquoisetemplate, orangetemplate, pinktemplate, voiceNoteStyle]
}

//  CAMBIOS REALIZADOS: CREACION DE LAS VARIABLES USANDO DESESTRUCTURACION DE DATOS
let [chatBg, asideBg, textNButtonBg, leftBg, rightBg, onlinecolor, ownerColor, bold, svgColor, text, lorem, ponlinetext, turquoisetemplate, orangetemplate, pinktemplate, voiceNoteStyle] = actualizador()
let actualColor = document.getElementById("pinktemplate")


turquoisetemplate.addEventListener('click', () => {
  const elementos = actualizador();
  [chatBg, asideBg, textNButtonBg, leftBg, rightBg, onlinecolor, ownerColor, bold, svgColor, text, lorem, ponlinetext, turquoisetemplate, orangetemplate, pinktemplate, voiceNoteStyle] = elementos;
